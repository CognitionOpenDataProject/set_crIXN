...
# standard error
compareValues(obtainedValue = sem(d_tidy$latency_direct_normed),  
              reportedValue = 9.51)
```
...
# standard error
compareValues(obtainedValue = sem(d_tidy$latency_averted_normed),  
              reportedValue = 9.51)
```
